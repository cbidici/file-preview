...
function Preview({previewResource, setPreviewResource, index}) {
    ...
    if(previewResource.type.startsWith("IMAGE")) {
      ...
      preview =
      <div style={{height:"0px", paddingTop:"56.25%", position:"relative", width:"100%"}}>
        <video display={isPreviewLoading ? "none" : "block"} ref={videoRef} id="" height="100%" style={{backgroundColor:"#f8f9fa", pointerEvents: 'auto', width:"100%", height:"100%", position:"absolute", top:"0", left:"0" }} controls autoPlay onCanPlay={onImageLoad} onEmptied={onImageLoad} playsInline webkit-playsInline>
